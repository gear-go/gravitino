...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 17 13:48:53 2018
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 17 13:20:14 2018
...
#        return positrons(Ce,gammae,Cp, gammap, Cs, gammas, Esi) / ( positrons(Ce,gammae,Cp, gammap, Cs, gammas, Esi) + electrons(Ce, gammae,Cp, gammap, Cs, gammas, Esi) )
    return spectrum(epp_AMS02_data['Ener'])
...
def loglike(cube,ndim,nparams):
        ...
        yerreppc = epp_AMS02_data['ERR_STATma']
        yeppc = epp_AMS02_data['VALUE']
...
ypdata = p_data['VALUE']
yedata = e_data['VALUE']
datafile = "fit_multines_D_Gravitino_AMS02_shade"
...
x = epp_AMS02_data['Ener']
shade = Shade(x)
for (Cp, gammap, Ce, gammae, Mdm, logfluxNorm, a1, a2, g, h, i, j) in a.get_equal_weighted_posterior()[::10,:-1]:
	shade.add((epp_AMS02_data['Ener']**3)*suma(Cp,gammap,Ce,gammae, Mdm, 10**logfluxNorm, a1, a2))
shade.line(color='k')
shade.shade(q=0.25, color='#008837', alpha=0.3)
shade.shade(q=0.5, color='#7b3294', alpha=0.3)
